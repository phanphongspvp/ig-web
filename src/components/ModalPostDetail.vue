    ...
    <div
        ...
        <div class="max-w-[930px] w-full h-[500px] bg-white shadow-md rounded-md flex" @click.stop>
            <div class="flex-1 w-[50%] flex items-center justify-center bg-black relative">
                    ...
                    <img :src="post?.imageUrls[indexImage]" :alt="post.content" class="transition-all select-none">
            ...
            <div class="flex-1 w-[50%] relative">
                ...
                <div class="absolute bottom-0 right-0 left-0 bg-white z-999">
                    <div class="px-6 border-t py-3 select-none">
...
onMounted(async () => {
    ...
    await store.dispatch("getLikeByUserAndPost", {
        userId: userId.value,
        postId: post.value._id
    });
    const like = computed(() => store.state.like.like);    
    if (post.value.likes.includes(like.value?._id)) isHeart.value = true;
})
