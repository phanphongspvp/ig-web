<template>
  <div class="w-[242px] h-screen border-r-gray-200 border-r pt-2 px-4 pb-5 flex flex-col justify-between fixed" @click.self="isModelMore = false">
    <div>
      ...
      <router-link to="/profile"
        ...
        <img class="w-6 h-6 rounded-full" :src="user?.avatar" alt="avatar" />
        Profile
      </router-link>
    </div>
    <div class="relative">
